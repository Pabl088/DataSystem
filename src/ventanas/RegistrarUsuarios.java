...
public class RegistrarUsuarios extends javax.swing.JFrame {
   ...
   // @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jButton_agregarUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/add.png"))); // NOI18N
        ...
        getContentPane().add(jButton_agregarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 170, 120, 100));
    ...
    private void jButton_agregarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_agregarUsuarioActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Error en registro de usuario");
                    }
            ...
            System.err.println("Error en validacion del nombre de usuario" + e);
            JOptionPane.showMessageDialog(null, "Error en conexion al validar nombre de usuario");
        }
