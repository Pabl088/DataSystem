...
public class Login extends javax.swing.JFrame {
   ...
   // @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jButton_acceder.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
    ...
    private void jButton_accederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_accederActionPerformed
        ...
        if (!user.equals("") && !pass.equals("")) {
            try {
                ...
                PreparedStatement pst = cn.prepareStatement("select tipo_nivel, estatus from usuarios where username = '"
                ...
                if (rs.next()) {
                    ...
                    if (tipo_nivel.equalsIgnoreCase("Capturista") && estatus.equalsIgnoreCase("Activo")) {
                        dispose();
                        new Capturista().setVisible(true);

                    }
                    if (tipo_nivel.equalsIgnoreCase("Tecnico") && estatus.equalsIgnoreCase("Activo")) {
                        dispose();
                ...
                System.err.println("Error en conexion a base de datos");
                JOptionPane.showMessageDialog(null, "Error en conexion, contacte a un administrador");
            }
